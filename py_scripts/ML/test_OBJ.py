...
def extract_aggregated_features(stats):
    ...
    for s in stats:
        ...
        if isinstance(val, list):
            ...
            if ftype in ('int', 'float', 'double', 'long'):
                try:
...
def generate_dpi(endpoints):
    ...
    dpi_model_is_dynamic = models.load_model('/mnt/c/Users/aviv/Desktop/newProject/pythonscripts/ML6/dpi_model_is_dynamic_array.h5', custom_objects=custom_objects)
    dpi_model_min_size = models.load_model('/mnt/c/Users/aviv/Desktop/newProject/pythonscripts/ML6/dpi_model_min_size.h5', custom_objects=custom_objects)
    dpi_model_max_size = models.load_model('/mnt/c/Users/aviv/Desktop/newProject/pythonscripts/ML6/dpi_model_max_size.h5', custom_objects=custom_objects)
    dpi_model_min_value = models.load_model('/mnt/c/Users/aviv/Desktop/newProject/pythonscripts/ML6/dpi_model_min_value.h5', custom_objects=custom_objects)
    dpi_model_max_value = models.load_model('/mnt/c/Users/aviv/Desktop/newProject/pythonscripts/ML6/dpi_model_max_value.h5', custom_objects=custom_objects)
            ...
            for alt_label, indices in seg_dict.items():
                ...
                if aggregated_field_type != "bitfield":
                    field_type_pred = aggregated_field_type
                                ...
                                # only do bit-counting when the original field was a bitfield
                if aggregated_field_type.lower() == 'bitfield':
                    bit_counts = [ sum(s['value']) for s in alt_stats if isinstance(s['value'], list) ]
